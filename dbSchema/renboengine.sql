...
-- ----------------------------
INSERT INTO `ren_domain` VALUES ('admin', '2', '0', '2018-02-01 22:57:23', 'http://222.200.180.59:10235/api/', 'PrUpNw1dM3zRH6j3eviklCHE9Zbvk9NavGcJ_CibW19h50Yvr-ZZYZqn5Gi_SG1cPVQEIZf2wAJgBmq4dhNj7w7t9wUEz2pcGhn-6kIRO--QqWy121gksPE8B103RtMzuOsQDcErk4LriRQRO7-Xqks-RtpBUnpInnS_lkkajQs');
INSERT INTO `ren_domain` VALUES ('sysu', '0', '0', '2018-06-01 16:33:24', 'http://222.200.180.59:10235/sysuapi', 'ejRqaEUStwk3L-UhrMRBM0qPjO860GwRDDbBhFENGv4v0rq3By5vu9DWck9SZxOW6B4EJMdRMvLdm9_DRxgerv5OnwBWeK2LMqi3SBrH79xw4ncq_86xSSvIrSUfSTLxIRBx8NxxwBdP-GI4DTGBojOZZu0atHstx1qP4Qt-rcA');
...
CREATE TABLE `ren_workitem` (
  ...
  `process_id` varchar(64) NOT NULL COMMENT 'belong to process global id',
  `bo_id` varchar(64) NOT NULL COMMENT 'belong to bo global id',
  `taskid` text NOT NULL COMMENT 'task id which is unique in a process',
  `task_polymorphism_id` text NOT NULL COMMENT 'task global id',
  `arguments` longtext COMMENT 'arguments for subsystem',
  `firing_time` datetime DEFAULT NULL,
  `enablement_time` datetime DEFAULT NULL,
  `start_time` datetime DEFAULT NULL,
  `completion_time` datetime DEFAULT NULL,
  `status` varchar(128) DEFAULT NULL COMMENT 'workitem status whether valid or not',
  `resource_status` varchar(128) DEFAULT NULL COMMENT 'resourcing status such as unoffer',
  `started_by` varchar(64) DEFAULT NULL COMMENT 'complete by what resource global id',
  `completed_by` varchar(64) DEFAULT NULL COMMENT 'complete by what resource global id',
  ...
  `latest_start_time` datetime DEFAULT NULL COMMENT 'last start timestamp',
  `execute_time` bigint(20) NOT NULL DEFAULT '0' COMMENT 'execution time cost in ms',
  `callback_node_id` varchar(64) NOT NULL,
  PRIMARY KEY (`wid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
