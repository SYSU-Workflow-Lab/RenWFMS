...
import org.sysu.workflow.core.ActionExecutionContext;
import org.sysu.workflow.core.BOXMLExecutionContext;
import org.sysu.workflow.core.Context;
import org.sysu.workflow.core.SCXMLExpressionException;
import org.sysu.workflow.core.model.EnterableState;
import org.sysu.workflow.core.model.ModelException;
import org.sysu.workflow.core.model.Param;
import org.sysu.workflow.core.model.ParamsContainer;
                        ...
                        if (!GlobalContext.IsLocalDebug) {
                            ...
                            for (int times = 0; times < timesBorder; times++) {
                                try {
                                    ...
                                    GlobalContext.Interaction.Send(assistantService.getRSLocation() + LocationContext.URL_RS_SUBMITTASK, args, scxmlExecContext.Rtid);
                                } catch (Exception e) {
